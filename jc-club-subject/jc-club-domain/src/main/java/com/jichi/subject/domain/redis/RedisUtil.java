package com.jichi.subject.domain.redis;
...
public class RedisUtil {
    ...
    public void putHash(String key, String hashKey, Integer value){
    ...
    public Set<ZSetOperations.TypedTuple<String>> rankWithScore(String key, int start, int end) {
