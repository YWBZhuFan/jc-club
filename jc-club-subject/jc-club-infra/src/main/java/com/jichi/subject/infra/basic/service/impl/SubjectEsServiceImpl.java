...
import com.jichi.subject.infra.basic.entity.EsSubjectFields;
import com.jichi.subject.infra.basic.entity.SubjectInfoEs;
import com.jichi.subject.infra.basic.es.EsIndexInfo;
import com.jichi.subject.infra.basic.es.EsRestClient;
import com.jichi.subject.infra.basic.es.EsSearchRequest;
import com.jichi.subject.infra.basic.es.EsSourceData;
...
public class SubjectEsServiceImpl implements SubjectEsService {
    ...
    private SubjectInfoEs convertResult(SearchHit hit) {
        ...
        result.setScore(new BigDecimal(String.valueOf(hit.getScore())).multiply(new BigDecimal("100.00")).setScale(2, BigDecimal.ROUND_HALF_UP));
        ...
        if (Objects.nonNull(subjectAnswerField)){
            Text[] fragments = subjectAnswerField.fragments();
    ...
    private EsIndexInfo getEsIndexInfo() {
        ...
        esIndexInfo.setClusterName("c1e3f56b7bca");
