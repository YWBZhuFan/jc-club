package com.jichi.auth.infra.basic.service.impl;


import com.jichi.auth.infra.basic.entity.AuthUser;
import com.jichi.auth.infra.basic.mapper.AuthUserDao;
import com.jichi.auth.infra.basic.service.AuthUserService;
...
public class AuthUserServiceImpl implements AuthUserService {
    ...
    @Override
    public Integer updateById(AuthUser authUser) {
        return this.authUserDao.updateById(authUser);
    }
